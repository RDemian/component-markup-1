...
// Собирает все html файлы по проекту, компилит их всех в один файл и выкидывает в dist data: 'src/data/',
function pages() {
...
function watch() {
	...
	gulp.watch('src/partials/**/*.{js,json,yml}').on('all', gulp.series(resetPages, pages, browser.reload));
    gulp.watch('src/helpers/**/*.js').on('all', gulp.series(resetPages, pages, browser.reload));
    gulp.watch('src/assets/scss/**/*.scss').on('all', sass);
    gulp.watch('src/partials/**/*.scss').on('all', sass);
